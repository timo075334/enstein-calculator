<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4 text-center text-sm text-black sm:text-left">
            {{ __("Don't have an account?") }}
            <a class="underline hover:text-black rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('register') }}">
                {{ __('Sign up') }}
            </a>
